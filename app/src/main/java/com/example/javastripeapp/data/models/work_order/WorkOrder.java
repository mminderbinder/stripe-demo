...
import com.example.javastripeapp.data.models.line_item.LineItem;
...
public class WorkOrder {
    ...
    public WorkOrder(String workOrderId, String customerId, String providerId, Map<String, LineItem> lineItemMap, WorkOrderStatus workOrderStatus) {
